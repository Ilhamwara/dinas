...
@section('head_title', 'Tambah Kegiatan Luar Negeri')


@section('title')
Tambah Data Kegiatan Luar Negeri
@endsection
                ...
                <form class="form-horizontal" id="kegiatanForm">
                    <div class="col-md-12">                       
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" value="luar_negeri" class="form-control" name="jenis_kegiatan" id="jenis_kegiatan" data-validation="required" required readonly>
                            </div>
                        </div>
                        <div class="form-group row">
    ...
    $(document).ready(function(){
        ...
        $('#kegiatanForm').validator().on('submit', function (e) {
            if (e.isDefaultPrevented()) {
                ...
                $.ajax({
                    url : '{{url('kegiatan/tambahajax_luar_negeri')}}',
                    type: 'POST',
                    dataType: 'JSON',
                    data: form.serialize(),
                    beforeSend: function(){
