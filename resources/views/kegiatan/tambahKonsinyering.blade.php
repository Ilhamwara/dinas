...
@section('head_title', 'Tambah Perjalanan Dinas Konsinyering')


@section('title')
Tambah Data Perjalanan Dinas Konsinyering
@endsection
                ...
                <form class="form-horizontal" id="kegiatanForm">
                    <div class="col-md-12">                       
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" value="konsinyering" class="form-control" name="jenis_kegiatan" id="jenis_kegiatan" data-validation="required" required readonly>
                            </div>
                        </div>
                        <div class="form-group row">
    ...
    <div class="col-lg-12">
        <section class="box">
            <div class="content-body" id="stBody">
                <div class="row">
                    <h3 class="page-header">Tambah Surat tugas untuk perjalanan dinas ini ini</h3>
    ...
    $(document).ready(function(){
        ...
        $('#kegiatanForm').validator().on('submit', function (e) {
            if (e.isDefaultPrevented()) {
                ...
                $.ajax({
                    url : '{{url('kegiatan/tambahajaxkonsinyering')}}',
                    type: 'POST',
                    dataType: 'JSON',
                    data: form.serialize(),
                    beforeSend: function(){
