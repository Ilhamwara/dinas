...
@section('head_title', 'Tambah Perjalanan Dinas Dalam Kota 8 Jam')


@section('title')
Tambah Data Perjalanan Dinas Dalam Kota 8 Jam
@endsection
            ...
            <div class="row">
                <form class="form-horizontal" id="kegiatanForm">
                    <div class="col-md-12">                       
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Jenis Perjalanan Dinas*</label>
                            <div class="col-md-7">
                                <input type="text" value="dalam_kota_8_jam" class="form-control" name="jenis_kegiatan" id="jenis_kegiatan" data-validation="required" required readonly>
                            </div>
                        </div>
                        <div class="form-group row">
    ...
    <div class="col-lg-12">
        <section class="box">
            <div class="content-body" id="stBody">
                <div class="row">
                    <h3 class="page-header">Tambah Surat tugas untuk perjalana dinas ini</h3>
    ...
    $(document).ready(function(){
        ...
        $('#kegiatanForm').validator().on('submit', function (e) {
            if (e.isDefaultPrevented()) {
                ...
                $.ajax({
                    url : '{{url('kegiatan/tambahajax_8_jam')}}',
                    type: 'POST',
                    dataType: 'JSON',
                    data: form.serialize(),
                    beforeSend: function(){
        ...
        $('#stForm').validator().on('submit', function (e) {
            if (e.isDefaultPrevented()) {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if (response.status) {
                            window.location.replace('{{url('surat-tugas')}}');
                    ...
                    error: function(response){
                        notie.alert('error', 'Ups, terjadi kesalahan saat menyimpan surat tugas', '2');
                        console.log(response);
                    }
                });
            }
