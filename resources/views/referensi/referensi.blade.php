                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        <ul>
                            ...
                            <li>Download template <a href="{{url('/template_referensi_perjadin.xlsx')}}" style="color:orange;text-decoration: underline;">disini</a></li>
                        </ul>
                    </div>
...
<div class="panel panel-default col-lg-12">
    <div class="panel-body">
        <a href="{{url('referensi/tambah')}}" class="btn btn-success pull-right" style="margin: 0px 5px;"><i class="fa fa-plus"></i> Tambah Referensi</a>
