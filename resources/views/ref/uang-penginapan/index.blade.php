...
@section('head_title', 'Uang Penginapan')
...
<li class="active"><i class="fa fa-building"></i> Uang Penginapan</li>
@endsection
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ URL::to('uang-penginapan/import') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        <ul>
                            ...
                            <li>Download template <a href="{{url('/template_uang_penginapan_perjadin.xlsx')}}" style="color:orange;text-decoration: underline;">disini</a></li>
                        </ul>
                    </div>
...
<div class="panel panel-default col-lg-12">
    <div class="panel-body">
        <a href="{{url('uang-penginapan/tambah')}}" class="btn btn-success pull-right" style="margin: 0px 5px;"><i class="fa fa-plus"></i> Tambah Referensi Uang Penginapan</a>
