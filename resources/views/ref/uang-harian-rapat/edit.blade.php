...
@section('head_title', 'Edit Uang Harian Rapat')

@section('title')
Edit Uang Harian Rapat
@endsection
...
<li class="active">Edit Uang Harian Rapat</li>
@endsection
...
<div class="panel panel-default col-lg-12">
    <div class="panel-body">
        <form method="post" action="{{url('uang-harian-rapat/edit-proses/'.$UangHarianRapat->id)}}" role="form" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select name="tujuan_dinas_id" class="form-control" required="required">
                        @forelse($UangHarianRapatAll as $k => $v)
                        <option value="{{$v->id}}" @if($v->id == $UangHarianRapat->id) selected @endif>{{$v->tujuan_dinas}}</option>
                        @empty
                        @endforelse
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="fullboard_lukot" value="{{$UangHarianRapat->fullboard_lukot}}" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <span class="input-group-addon"><b>Rp</b></span>
                        <input type="text" class="form-control" name="fullboard_dakot" value="{{$UangHarianRapat->fullhalf_dakot}}" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <span class="input-group-addon"><b>Rp</b></span>
                        <input type="text" class="form-control" name="fullhalf_dakot" value="{{$UangHarianRapat->fullhalf_dakot}}" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
