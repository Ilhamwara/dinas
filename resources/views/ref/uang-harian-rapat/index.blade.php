...
@section('head_title', 'Uang Harian Rapat')
...
<li class="active"><i class="fa fa-info"></i> Uang Harian Rapat</li>
@endsection
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ URL::to('uang-harian-rapat/import') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        <ul>
                            ...
                            <li>Download template <a href="{{url('/template_uang_harian_rapat_perjadin.xlsx')}}" style="color:orange;text-decoration: underline;">disini</a></li>
                        </ul>
                    </div>
...
<div class="panel panel-default col-lg-12">
    <div class="panel-body">
        <a href="{{url('uang-harian-rapat/tambah')}}" class="btn btn-success pull-right" style="margin: 0px 5px;"><i class="fa fa-plus"></i> Tambah Uang Rapat</a>
