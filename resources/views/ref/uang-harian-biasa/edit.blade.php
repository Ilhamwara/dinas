...
@section('head_title', 'Edit Uang Harian Biasa')

@section('title')
Edit Uang Harian Biasa
@endsection
...
<li class="active">Edit Uang Harian Biasa</li>
@endsection
...
<div class="panel panel-default col-lg-12">
    <div class="panel-body">
        <form method="post" action="{{url('uang-harian/edit-proses/'.$UangHarian->id)}}" role="form" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select name="tujuan_dinas_id" class="form-control" required="required">
                        ...
                        <option value="{{$v->id}}" @if($v->id == $UangHarian->id) selected @endif>{{$v->tujuan_dinas}}</option>
                        @empty
                        @endforelse
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="uang_harian_luar_kota" value="{{$UangHarian->luar_kota}}" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <span class="input-group-addon"><b>Rp</b></span>
                        <input type="text" class="form-control" name="uang_harian_dalam_kota" value="{{$UangHarian->dalam_kota}}" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <span class="input-group-addon"><b>Rp</b></span>
                        <input type="text" class="form-control" name="uang_harian_diklat" value="{{$UangHarian->diklat}}" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
